...
shinyUI(
    fluidPage(
        ...
        fluidRow(
            ...
            # ),
            column(4,
                   a(img(src = "logo_new.png", height = 80, width = 220, style = "float:right"), href = "http://sybila.fi.muni.cz/home", target="_blank"),
                   a(img(src = "aec_badge_cav.svg", height = 80, width = 80, style = "float:right; padding: 5px 5px 5px 5px"), 
