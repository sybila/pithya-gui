...
Editor_model_Browse_label <- "Browse"
...
Editor_property_Browse_label <- "Browse"
...
Editor_fastApproximation_tooltip <- ""
...
Explorer_activate_label <- "activate!"
Explorer_activate_tooltip <- ""
...
#WARNING STRING CONTAINS A PARAMETER
Explorer_parameter_label <- "parameter $PARAM"
Explorer_parameter_tooltip <- "Sets parameter value."

Explorer_addPlot_label <- "add plot"
Explorer_addPlot_tooltip <- "Add new plot for vector field or state space."
...
Result_activate_label <- "activate!"
Result_activate_tooltip <- ""

Result_Browse_label <- "Browse"
Result_Browse_tooltip <- "Load model checking result file."

Result_saveResults_label <- "save results"
Result_saveResults_tooltip <- "Save model checking results as file."

Result_showParametersCoverage_label <- "show parameters coverage"
Result_showParametersCoverage_tooltip <- ""
...
Result_VF_label <- "parameter-variable dependency plot:"
Result_VF_tooltip <- ""

Result_VF_DeselectClick_label <- "Deselect click"
Result_VF_DeselectClick_tooltip <- ""

Result_VF_Unzoom_label <- "Unzoom"
Result_VF_Unzoom_tooltip <- "Unzoom this vector field plot."

Result_VF_discreteScaleInX_label <- "discrete scale in x"
Result_VF_discreteScaleInX_tooltip <- ""

Result_SS_label <- "state space:" # "state space of the model:"
Result_SS_tooltip <- ""
